...
xst -ifn xst.scr
move Interface_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\Interface_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc Interface_exdes.ucf Interface_exdes

echo 'Running map'
map -timing Interface_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm Interface_exdes -w routed.ncd routed.vhd
cd ..
